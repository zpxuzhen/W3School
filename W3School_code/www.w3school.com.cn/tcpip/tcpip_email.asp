...
<li class="currentLink"><a href="tcpip_email.asp" title="TCP/IP 邮件">TCP/IP 邮件</a></li>
</ul>
</div><div id="selected">
<h2>建站手册</h2>
<ul>
...
<div id="tpn">
<ul class="prenext">
<li class="pre"><a href="tcpip_protocols.asp" title="TCP/IP 协议">TCP/IP 协议</a></li>
<li class="next"><a href="index.asp" title="TCP/IP 教程">TCP/IP 教程</a></li>
</ul>
</div>
