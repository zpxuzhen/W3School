...
<li class="currentLink"><a href="html_5_form_elements.asp" title="HTML5 表单元素">HTML5 表单元素</a></li>
...
<div id="tpn">
<ul class="prenext">
<li class="pre"><a href="html_5_form_input_types.asp" title="HTML5 Input 类型">HTML5 输入类型</a></li>
<li class="next"><a href="html_5_form_attributes.asp" title="HTML5 表单属性">HTML5 表单属性</a></li>
</ul>
</div>
...
<p class="tiy"><a target="_blank" href="../tiy/t.asp@f=html5_form_keygen">亲自试一试</a></p>
</div>
...
<p class="tiy"><a target="_blank" href="../tiy/t.asp@f=html5_form_output">亲自试一试</a></p>
</div>
