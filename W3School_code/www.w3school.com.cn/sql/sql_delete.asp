...
<li class="currentLink"><a href="sql_delete.asp" title="SQL DELETE 语句">SQL delete</a></li>
</ul>
<h2>SQL 高级教程</h2>
<ul>
...
<div id="tpn">
<ul class="prenext">
<li class="pre"><a href="sql_update.asp" title="SQL UPDATE 语句">SQL update</a></li>
<li class="next"><a href="sql_top.asp" title="SQL TOP 子句">SQL Top</a></li>
</ul>
</div>
