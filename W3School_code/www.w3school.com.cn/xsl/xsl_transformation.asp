...
<li class="currentLink"><a href="xsl_transformation.asp" title="XSLT - 转换">XSLT 转换</a></li>
...
<div id="tpn">
<ul class="prenext">
<li class="pre"><a href="xsl_browsers.asp" title="对 XSLT 的浏览器支持">XSLT 浏览器</a></li>
<li class="next"><a href="xsl_templates.asp" title="XSLT &lt;xsl:template&gt; 元素">XSLT &lt;template&gt;</a></li>
</ul>
</div>
