...
<h2>XSLT 高级</h2>
<ul>
<li class="currentLink"><a href="xsl_client.asp" title="XSLT - 客户端">XSLT 在客户端</a></li>
...
<div id="tpn">
<ul class="prenext">
<li class="pre"><a href="xsl_apply_templates.asp" title="XSLT &lt;xsl:apply-templates&gt; 元素">XSLT apply</a></li>
<li class="next"><a href="xsl_server.asp" title="XSLT - 在服务器上">XSLT 在服务器端</a></li>
</ul>
</div>
...
<p class="tiy"><a target="_blank" href="../tiy/t.asp@f=xmle_cdcatalog">请看它在 IE 中如何工作</a>。</p>
</div>
