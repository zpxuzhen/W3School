...
<li class="currentLink"><a href="xsl_editors.asp" title="XSLT 编辑器">XSLT 编辑器</a></li>
...
<div id="tpn">
<ul class="prenext">
<li class="pre"><a href="xsl_editxml.asp" title="XSLT - 编辑 XML">XSLT 编辑 XML</a></li>
<li class="next"><a href="xsl_summary.asp" title="您已经学习了 XSLT，下一步呢？">XSLT 教程总结</a></li>
</ul>
</div>
