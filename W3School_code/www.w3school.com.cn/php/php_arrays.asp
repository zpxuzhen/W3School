...
<p class="tiy"><a target="_blank" href="../tiy/s.asp@f=demo_php_array_num">运行实例</a></p>
</div>
...
<p class="tiy"><a target="_blank" href="../tiy/s.asp@f=demo_php_array_length">运行实例</a></p>
</div>
...
<p class="tiy"><a target="_blank" href="../tiy/s.asp@f=demo_php_array_num_loop">运行实例</a></p>
</div>
...
<p class="tiy"><a target="_blank" href="../tiy/s.asp@f=demo_php_array_assoc">运行实例</a></p>
</div>
...
<p class="tiy"><a target="_blank" href="../tiy/s.asp@f=demo_php_array_assoc_loop">运行实例</a></p>
</div>
