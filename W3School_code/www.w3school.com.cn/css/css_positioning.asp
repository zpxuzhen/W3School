...
<h2>CSS 定位</h2>
<ul>
<li class="currentLink"><a href="css_positioning.asp" title="CSS 定位概述">CSS 定位概述</a></li>
...
<div id="tpn">
<ul class="prenext">
<li class="pre"><a href="css_margin_collapsing.asp" title="CSS 外边距合并">CSS 外边距合并</a></li>
<li class="next"><a href="css_positioning_relative.asp" title="CSS 相对定位">CSS 相对定位</a></li>
</ul>
</div>
