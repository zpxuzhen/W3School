...
<h2>显示</h2>
<dl>
<dt><a target="_blank" href="../tiy/s.asp@f=demo_adoe_display_1">显示记录</a></dt>
<dt><a target="_blank" href="../tiy/s.asp@f=demo_adoe_display_2">在 HTML 表格中显示记录</a></dt>
<dt><a target="_blank" href="../tiy/s.asp@f=demo_adoe_display_3">向 HTML 表添添加标题</a></dt>
<dt><a target="_blank" href="../tiy/s.asp@f=demo_adoe_display_4">向 HTML 表格添加颜色</a></dt>
</dl>
</div>
...
<h2>查询</h2>
<dl>
<dt><a target="_blank" href="../tiy/s.asp@f=demo_adoe_query_1">显示 "Companyname" 以 A 开头的记录</a></dt>
<dt><a target="_blank" href="../tiy/s.asp@f=demo_adoe_query_2">显示 "Companyname" 大于 E 的记录</a></dt>
<dt><a target="_blank" href="../tiy/s.asp@f=demo_adoe_query_3">仅显示中国的客户</a></dt>
<dt><a target="_blank" href="../tiy/s.asp@f=demo_adoe_query_4">让用户来选择过滤条件</a></dt>
</dl>
</div>
...
<h2>排序</h2>
<dl>
<dt><a target="_blank" href="../tiy/s.asp@f=demo_adoe_sort_1">根据指定的字段名称进行升序排序</a></dt>
<dt><a target="_blank" href="../tiy/s.asp@f=demo_adoe_sort_2">根据指定的字段名称进行降序排序</a></dt>
<dt><a target="_blank" href="../tiy/s.asp@f=demo_adoe_sort_3">让用户来选择根据那一列来进行排序</a></dt>
</dl>
</div>
...
<h2>Recordset 对象</h2>
<dl>
<dt><a target="_blank" href="../tiy/s.asp@f=demo_adoe_getrows">GetRows</a></dt>
<dt><a target="_blank" href="../tiy/s.asp@f=demo_adoe_display_5">GetString</a></dt>
</dl>
</div>
