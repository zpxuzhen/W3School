...
<dl>
<dt><a target="_blank" href="../tiy/t.asp@f=xdom_parser">加载并解析 XML 文件</a></dt>
<dt><a target="_blank" href="../tiy/t.asp@f=xdom_parser2">加载并解析 XML 字符串</a></dt>
</dl>
...
<dl>
<dt><a target="_blank" href="../tiy/t.asp@f=xdom_parsertest">加载并解析 XML 文件</a></dt>
<dt><a target="_blank" href="../tiy/t.asp@f=xdom_parsertest2">加载并解析 XML 字符串</a></dt>
</dl>
...
<dl>
<dt><a target="_blank" href="../tiy/t.asp@f=xdom_index">使用节点列表中的下标号来访问节点</a></dt>

<dt><a target="_blank" href="../tiy/t.asp@f=xdom_list_loop">使用 length 属性来循环节点</a></dt>

<dt><a target="_blank" href="../tiy/t.asp@f=xdom_root">查看元素的节点类型</a></dt>

<dt><a target="_blank" href="../tiy/t.asp@f=xdom_loop">循环元素节点</a></dt>

<dt><a target="_blank" href="../tiy/t.asp@f=xdom_navigate">使用节点的关系来循环元素节点</a></dt>
</dl>
...
<dl>
<dt><a target="_blank" href="../tiy/t.asp@f=xdom_nodename3">获取元素节点的节点名称</a></dt>

<dt><a target="_blank" href="../tiy/t.asp@f=xdom_getelement">从文本节点获取文本</a></dt>

<dt><a target="_blank" href="../tiy/t.asp@f=xdom_changeelement">更改文本节点中的文本</a></dt>

<dt><a target="_blank" href="../tiy/t.asp@f=xdom_root">获取元素节点的节点名称和类型</a></dt>
</dl>
...
<dl>
<dt><a target="_blank" href="../tiy/t.asp@f=xdom_nodelist">从第一个 &lt;title&gt; 元素获取文本</a></dt>

<dt><a target="_blank" href="../tiy/t.asp@f=xdom_nodelist_length">通过使用 length 属性来循环节点</a></dt>

<dt><a target="_blank" href="../tiy/t.asp@f=xdom_attributes">获取元素的属性</a></dt>
</dl>
...
<dl>
<dt><a target="_blank" href="../tiy/t.asp@f=xdom_parsertest3">遍历一棵节点树</a></dt>
...
<dl>
<dt><a target="_blank" href="../tiy/t.asp@f=xdom_nodetype_ievsmozilla">显示节点列表的长度</a></dt>
<dd>本例显示了一个节点列表的长度。在 IE 和其他浏览器中，结果是不同的。</dd>

<dt><a target="_blank" href="../tiy/t.asp@f=xdom_nodetype_ievsmozilla2">忽略节点间的空文本</a></dt>
...
<dl>
<dt><a target="_blank" href="../tiy/t.asp@f=xdom_nav_parentnode">获取节点的父节点</a></dt>
<dt><a target="_blank" href="../tiy/t.asp@f=xdom_nav_firstchild">获取节点的首个子节点</a></dt>
<dt><a target="_blank" href="../tiy/t.asp@f=xdom_nav_lastchild">获取节点的最后一个子节点</a></dt>
<dt><a target="_blank" href="../tiy/t.asp@f=xdom_nav_nextsibling">获取节点的下一个同级元素</a></dt>
<dt><a target="_blank" href="../tiy/t.asp@f=xdom_nav_prevsibling">获取节点的上一个同级元素</a></dt>
</dl>
...
<dl>
<dt><a target="_blank" href="../tiy/t.asp@f=xdom_getelementsbytagname">获取元素的值</a></dt>
<dt><a target="_blank" href="../tiy/t.asp@f=xdom_getattribute">获取属性的值</a></dt>
</dl>
...
<dl>
<dt><a target="_blank" href="../tiy/t.asp@f=xdom_nodevalue_change">改变元素的文本节点</a></dt>

<dt><a target="_blank" href="../tiy/t.asp@f=xdom_setattribute_1">通过使用 setAttribute 来改变属性的值</a></dt>

<dt><a target="_blank" href="../tiy/t.asp@f=xdom_att_nodevalue">通过使用 nodeValue 来改变属性值</a></dt>
</dl>
...
<dl>
<dt><a target="_blank" href="../tiy/t.asp@f=xdom_removechild">删除元素节点</a></dt>

<dt><a target="_blank" href="../tiy/t.asp@f=xdom_removecurrent">删除当前元素节点</a></dt>

<dt><a target="_blank" href="../tiy/t.asp@f=xdom_removetextnode">删除文本节点</a></dt>

<dt><a target="_blank" href="../tiy/t.asp@f=xdom_remove_nodevalue">清空文本节点的文本</a></dt>

<dt><a target="_blank" href="../tiy/t.asp@f=xdom_removeattribute">根据名称删除属性</a></dt>

<dt><a target="_blank" href="../tiy/t.asp@f=xdom_removeattributenode">根据对象删除属性</a></dt>
</dl>
...
<dl>
<dt><a target="_blank" href="../tiy/t.asp@f=xdom_replacechild">替换元素节点</a></dt>

<dt><a target="_blank" href="../tiy/t.asp@f=xdom_replacedata_2">替换文本节点中的数据</a></dt>
</dl>
...
<dl>
<dt><a target="_blank" href="../tiy/t.asp@f=xdom_createelement_1">创建元素节点</a></dt>

<dt><a target="_blank" href="../tiy/t.asp@f=xdom_createattribute">通过使用 createAttribute 来创建属性节点</a></dt>

<dt><a target="_blank" href="../tiy/t.asp@f=xdom_createattribute_3">通过使用 setAttribute 来创建属性节点</a></dt>

<dt><a target="_blank" href="../tiy/t.asp@f=xdom_createelement_1">创建文本节点</a></dt>

<dt><a target="_blank" href="../tiy/t.asp@f=xdom_createcdatasection_1">创建一个 CDATA section 节点</a></dt>

<dt><a target="_blank" href="../tiy/t.asp@f=xdom_createcomment_1">创建注释节点</a></dt>
</dl>
...
<dl>
<dt><a target="_blank" href="../tiy/t.asp@f=xdom_createelement_2">在最后一个子节点之后添加一个节点</a></dt>

<dt><a target="_blank" href="../tiy/t.asp@f=xdom_insertbefore">在指定的子节点之前添加一个节点</a></dt>

<dt><a target="_blank" href="../tiy/t.asp@f=xdom_createattribute_3">添加一个新属性</a></dt>

<dt><a target="_blank" href="../tiy/t.asp@f=xdom_insertdata">向文本节点添加数据</a></dt>
</dl>
...
<dl>
<dt><a target="_blank" href="../tiy/t.asp@f=xdom_clonenode">复制一个节点，并把它追加到已有的节点</a></dt>
