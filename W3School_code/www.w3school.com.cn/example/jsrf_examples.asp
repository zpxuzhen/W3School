...
<dl>
<dt><a target="_blank" href="../tiy/t.asp@f=jsrf_string_length">返回字符串的长度</a></dt>

<dt><a target="_blank" href="../tiy/t.asp@f=jsrf_string_style">为字符串添加样式</a></dt>

<dt><a target="_blank" href="../tiy/t.asp@f=jsrf_string_indexof">返回字符串中指定文本首次出现的位置 - indexOf()方法</a></dt>

<dt><a target="_blank" href="../tiy/t.asp@f=jsrf_string_match">查找字符串中特定的字符，若找到，则返回该字符 - match() 方法</a></dt>

<dt><a target="_blank" href="../tiy/t.asp@f=jseg_replace_1">替换字符串中的字符 - replace()</a></dt>
</dl>
...
<dl>
<dt><a target="_blank" href="../tiy/t.asp@f=jsrf_date">使用 Date() 方法来返回今天的日期和时间</a></dt>

<dt><a target="_blank" href="../tiy/t.asp@f=jseg_gettime">使用 getTime() 计算从1970年到今天有多少年</a></dt>

<dt><a target="_blank" href="../tiy/t.asp@f=jsrf_date_setfullyear2">使用 setFullYear() 设置具体的日期</a></dt>

<dt><a target="_blank" href="../tiy/t.asp@f=jsrf_date_toutcstring">使用 toUTCString() 把当日的日期（根据 UTC）转换为字符串</a></dt>

<dt><a target="_blank" href="../tiy/t.asp@f=jsrf_date_date_weekday">使用 getDay() 来显示星期，而不仅仅是数字</a></dt>

<dt><a target="_blank" href="../tiy/t.asp@f=jsrf_date_timing_clock">显示一个钟表</a></dt>
</dl>
...
<dl>
<dt><a target="_blank" href="../tiy/t.asp@f=jsrf_array">创建数组</a></dt>

<dt><a target="_blank" href="../tiy/t.asp@f=jsrf_array_for_in">使用 for...in 声明来遍历数组中的元素</a></dt>

<dt><a target="_blank" href="../tiy/t.asp@f=jseg_concat_2">合并两个数组 - concat()</a></dt>

<dt><a target="_blank" href="../tiy/t.asp@f=jseg_join">用数组的元素组成字符串 - join()</a></dt>

<dt><a target="_blank" href="../tiy/t.asp@f=jseg_sort_1">文字数组 - sort()</a></dt>

<dt><a target="_blank" href="../tiy/t.asp@f=jseg_sort_2">数字数组 - sort()</a></dt>
</dl>
...
<dl>
<dt><a target="_blank" href="../tiy/t.asp@f=jsrf_boolean">检查逻辑值</a></dt>
</dl>
...
<dl>
<dt><a target="_blank" href="../tiy/t.asp@f=jsrf_math_round">使用 round() 对数字进行舍入</a></dt>
<dt><a target="_blank" href="../tiy/t.asp@f=jsrf_math_random">使用 random() 来返回 0 到 1 之间的随机数</a></dt>
<dt><a target="_blank" href="../tiy/t.asp@f=jsrf_math_max">使用 max() 来返回两个给定的数中的较大的数</a></dt>
<dt><a target="_blank" href="../tiy/t.asp@f=jsrf_math_min">使用 min() 来返回两个给定的数中的较小的数</a></dt>
</dl>
