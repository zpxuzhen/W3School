...
<div id="tpn">
<ul class="prenext">
<li class="pre"><a href="media_realvideo.asp" title="播放 Real Video 影片">Object RealVideo</a></li>
<li class="next"><a href="media_playerref.asp" title="Windows Media Player 参考手册">播放器参考</a></li>
</ul>
</div>
