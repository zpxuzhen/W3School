...
<li class="currentLink"><a href="media_playerref.asp" title="Windows Media Player 参考手册">播放器参考</a></li>
...
<div id="tpn">
<ul class="prenext">
<li class="pre"><a href="media_tagref.asp" title="Web 多媒体元素参考手册">标签参考</a></li>
<li class="next"><a href="media_mimeref.asp" title="MIME 参考手册">MIME 参考</a></li>
</ul>
</div>
