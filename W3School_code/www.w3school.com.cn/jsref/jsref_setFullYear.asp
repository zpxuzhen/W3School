...
<dl>
<dt><a target="_blank" href="../tiy/t.asp@f=jseg_setfullyear">setFullYear()</a></dt>
<dd>如何使用 setFullYear() 来设置年份。</dd>
<dt><a target="_blank" href="../tiy/t.asp@f=jseg_setfullyear2">使用 setFullYear() 来设置具体的日期</a></dt>
