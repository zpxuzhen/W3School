...
<h2>TIY</h2>
<dl>
<dt><a target="_blank" href="../tiy/t.asp@f=hdom_text_value">获得文本域的值</a></dt>
<dt><a target="_blank" href="../tiy/t.asp@f=hdom_formvalidate">表单验证</a></dt>
<dt><a target="_blank" href="../tiy/t.asp@f=hdom_form_radio">表单中的单选按钮</a></dt>
<dt><a target="_blank" href="../tiy/t.asp@f=hdom_form_checkbox">表单中的复选按钮</a></dt>
