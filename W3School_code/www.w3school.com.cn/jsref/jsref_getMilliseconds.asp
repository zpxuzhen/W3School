...
<dl>
<dt><a target="_blank" href="../tiy/t.asp@f=jseg_getmilliseconds">getMilliseconds()</a></dt>
<dd>如何使用 getMilliseconds() 来取得当前的毫秒。</dd>
<dt><a target="_blank" href="../tiy/t.asp@f=jseg_datetime">显示当前时间</a></dt>
<dd>如何使用 getHours(), getMinutes() 以及 getSeconds() 来显示当前的时间。</dd>
<dt><a target="_blank" href="../tiy/t.asp@f=jseg_datetime2">显示当前时间（带有一个判断数值是否小于 10 的函数）</a></dt>
<dd>如何使用 getHours(), getMinutes() 以及 getSeconds() 来显示当前的时间。</dd>
</dl>
</div>
