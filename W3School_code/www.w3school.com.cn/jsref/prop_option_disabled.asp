...
<h2>TIY</h2>
<dl>
<dt><a target="_blank" href="../tiy/t.asp@f=hdom_option_disabled_selected">检测某个选项是否被默认地禁用</a></dt>
<dt><a target="_blank" href="../tiy/t.asp@f=hdom_option_disabled_id">通过 id 禁用某个选项</a></dt>
</dl>
</div>
