...
<dl>
<dt><a target="_blank" href="../tiy/t.asp@f=jseg_getUTCmilliseconds">getUTCMilliseconds()</a></dt>
<dd>如何使用 getUTCMilliseconds() 来取得当前的 UTC 毫秒。</dd>
<dt><a target="_blank" href="../tiy/t.asp@f=jseg_datetime_UTC">显示当前的 UTC 时间</a></dt>
<dd>如何使用 getUTCHours() 显示当前的 UTC 时间。</dd>
<dt><a target="_blank" href="../tiy/t.asp@f=jseg_datetime_UTC_2">显示当前的 UTC 时间（带有一个判断数值是否小于 10 的函数） </a></dt>
