...
<li class="currentLink"><a href="dom_navigation.asp" title="HTML DOM 导航">DOM 导航</a></li>
...
<div id="tpn">
<ul class="prenext">
<li class="pre"><a href="dom_events.asp" title="HTML DOM 事件">DOM 事件</a></li>
<li class="next"><a href="dom_summary.asp" title="您已经学习了 HTML DOM，接下来的学习内容是什么呢？">DOM 总结</a></li>
</ul>
</div>
