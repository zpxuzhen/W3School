...
<li class="currentLink"><a href="dom_events.asp" title="HTML DOM 事件">DOM 事件</a></li>
...
<div id="tpn">
<ul class="prenext">
<li class="pre"><a href="dom_elements.asp" title="HTML DOM 元素">DOM 元素</a></li>
<li class="next"><a href="dom_navigation.asp" title="HTML DOM 导航">DOM 导航</a></li>
</ul>
</div>
...
<p>如需每个事件的完整描述和例子，请访问我们的 <a href="../jsref/index.asp" title="JavaScript 和 HTML DOM 参考手册">HTML DOM 参考手册</a>。</p>
</div>
