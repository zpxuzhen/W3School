...
<li class="currentLink"><a href="aspnet_arraylist.asp" title="WebForms ArrayList">WebForms ArrayList</a></li>
...
<div id="tpn">
<ul class="prenext">
<li class="pre"><a href="aspnet_databinding.asp" title="WebForms Data Binding">WebForms 数据绑定</a></li>
<li class="next"><a href="aspnet_hashtable.asp" title="WebForms Hashtable">WebForms Hashtable</a></li>
</ul>
</div>
...
<p class="tiy"><a target="_blank" href="../tiy/s.asp@f=demo_aspnet_arraylist_drop_1">ArrayList DropDownList</a></p>

<p class="tiy"><a target="_blank" href="../tiy/s.asp@f=demo_aspnet_arraylist_radio_1">ArrayList RadioButtonList</a></p>
...
<p class="tiy"><a target="_blank" href="../tiy/s.asp@f=demo_aspnet_arraylist_radio_1">显示这个例子</a></p>
