...
<h2>实例</h2>
<dl>
<dt><a target="_blank" href="../tiy/s.asp@f=demo_aspnet_validationsum_1">Validationsummary</a></dt>
<dd>在本例中，我们使用 ValidationSummary 控件生成了一个用户未填的必选字段的列表。</dd>

<dt><a target="_blank" href="../tiy/s.asp@f=demo_aspnet_validationsum_2">Validationsummary 2</a></dt>
