...
<li class="currentLink"><a href="aspnet_events.asp" title="WebForms 事件">WebForms 事件</a></li>
...
<div id="tpn">
<ul class="prenext">
<li class="pre"><a href="aspnet_controls.asp" title="WebForms 控件">WebForms 控件</a></li>
<li class="next"><a href="aspnet_forms.asp" title="WebForms 窗体">WebForms 窗体</a></li>
</ul>
</div>
...
<p class="tiy"><a target="_blank" href="../tiy/s.asp@f=demo_aspnet_pageload">显示这个例子</a></p>
</div>
...
<p class="tiy"><a target="_blank" href="../tiy/s.asp@f=demo_aspnet_pageispostback">显示这个例子</a></p>
</div>
