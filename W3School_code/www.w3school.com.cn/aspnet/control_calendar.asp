...
<h2>实例</h2>
<dl>
<dt><a target="_blank" href="../tiy/s.asp@f=demo_aspnet_calendar_1">Calendar</a></dt>
<dd>在本例中，我们在 .aspx 文件中声明了一个使用最为简单的 Calendar 控件。</dd>

<dt><a target="_blank" href="../tiy/s.asp@f=demo_aspnet_calendar_2">Calendar 2</a></dt>
<dd>在本例中，我们在 .aspx 文件中声明一个 Calendar 控件。日期以蓝色的完整名称显示，周末以黄色背景红色文字显示，而当前日期使用绿色背景显示。</dd>

<dt><a target="_blank" href="../tiy/s.asp@f=demo_aspnet_calendar_3">Calendar 3</a></dt>
