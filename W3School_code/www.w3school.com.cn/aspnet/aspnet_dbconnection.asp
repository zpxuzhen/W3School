...
<li class="currentLink"><a href="aspnet_dbconnection.asp" title="WebForms DbConnection">WebForms 数据库连接</a></li>
...
<div id="tpn">
<ul class="prenext">
<li class="pre"><a href="aspnet_datalist.asp" title="WebForms DataList">WebForms DataList</a></li>
<li class="next"><a href="aspnet_masterpages.asp" title="WebForms Master Pages">WebForms 母版页</a></li>
</ul>
</div>
...
<h2>实例</h2>
<dl>
<dt><a target="_blank" href="../tiy/s.asp@f=demo_aspnet_dbconn_repeater">数据库连接 - 绑定到 Repeater 控件</a></dt>
<dt><a target="_blank" href="../tiy/s.asp@f=demo_aspnet_dbconn_datalist">数据库连接 - 绑定到 DataList 控件</a></dt>
</dl>
</div>
...
<p class="tiy"><a target="_blank" href="../tiy/s.asp@f=demo_aspnet_dbconn_repeater">显示这个例子</a></p>
</div>
