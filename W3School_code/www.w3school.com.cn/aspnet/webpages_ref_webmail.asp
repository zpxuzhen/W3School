...
<li class="currentLink"><a href="webpages_ref_webmail.asp" title="WebPages WebMail">WebPages WebMail</a></li>
...
<div id="tpn">
<ul class="prenext">
<li class="pre"><a href="webpages_ref_database.asp" title="WebPages 数据库">WebPages 数据库</a></li>
<li class="next"><a href="webpages_ref_helpers.asp" title="WebPages 助手">WebPages 助手</a></li>
</ul>
</div>
...
<p>参阅 <a href="webpages_email.asp" title="ASP.NET Web Pages - WebMail 帮助器">Web Pages 邮件</a> 这一章中的实例。</p>
</div>
