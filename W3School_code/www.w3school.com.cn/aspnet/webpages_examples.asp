...
<li class="currentLink"><a href="webpages_examples.asp" title="WebPages 实例">WebPages 实例</a></li>
</ul>
<h2>WP 参考手册</h2>
<ul>
...
<div id="tpn">
<ul class="prenext">
<li class="pre"><a href="webpages_publish.asp" title="WebPages 发布">WebPages 发布</a></li>
<li class="next"><a href="webpages_ref_classes.asp" title="WebPages 类">WebPages 类</a></li>
</ul>
</div>
