...
<h2>实例</h2>
<dl>
<dt><a target="_blank" href="../tiy/s.asp@f=demo_aspnet_listitem">在 BulletedList 中的基本 ListItem</a></dt>
<dd>本例展示了 .aspx 文件中带有两个 ListItems 的 BulletedList 控件。</dd>

<dt><a target="_blank" href="../tiy/s.asp@f=demo_aspnet_listitem_text">ListBox 中带有不同属性的 ListItem</a></dt>
<dd>本例展示了 .aspx 文件中带有几个 ListItem 的 ListBox 控件。列表中的文本使用了不同的属性来显示列表项的文本。</dd>

<dt><a target="_blank" href="../tiy/s.asp@f=demo_aspnet_listitem_disabled">ListItem disabled in ListBox</a></dt>
<dd>本例展示了一个带有被禁用的列表项的 ListBox 控件。</dd>

<dt><a target="_blank" href="../tiy/s.asp@f=demo_aspnet_listitem_selected">ListItem selected in RadioButtonList</a></dt>
