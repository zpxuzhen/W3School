...
<li class="currentLink"><a href="webpages_email.asp" title="WebPages 电邮">WebPages 电邮</a></li>
...
<div id="tpn">
<ul class="prenext">
<li class="pre"><a href="webpages_chart.asp" title="WebPages 图表">WebPages 图表</a></li>
<li class="next"><a href="webpages_php.asp" title="WebPages PHP">WebPages PHP</a></li>
</ul>
</div>
...
<p>如需更多有关从 ASP.NET Web Pages 应用程序发送电子邮件的信息，请参阅：<a href="webpages_ref_webmail.asp" title="ASP.NET Web Pages - WebMail 对象">WebMail 对象参考手册</a>。</p>
</div>
