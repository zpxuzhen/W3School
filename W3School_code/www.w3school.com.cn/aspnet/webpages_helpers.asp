...
<li class="currentLink"><a href="webpages_helpers.asp" title="WebPages 帮助器">WebPages 帮助器</a></li>
...
<div id="tpn">
<ul class="prenext">
<li class="pre"><a href="webpages_files.asp" title="WebPages 文件">WebPages 文件</a></li>
<li class="next"><a href="webpages_webgrid.asp" title="WebPages WebGrid">WebPages WebGrid</a></li>
</ul>
</div>
...
<p>在 <a href="webpages_ref_helpers.asp" title="ASP.NET Web Pages - 更多帮助器">W3School 的 Helper 参考手册</a>中，我们提供了相关的快速参考，关于您能够安装的（属于名为 ASP.NET Web Helpers Library 的一部分的）内建帮助器和其他帮助器。</p>
