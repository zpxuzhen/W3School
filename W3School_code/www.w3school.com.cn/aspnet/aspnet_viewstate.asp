...
<div id="tpn">
<ul class="prenext">
<li class="pre"><a href="aspnet_forms.asp" title="WebForms 窗体">WebForms 窗体</a></li>
...
<p class="tiy"><a target="_blank" href="../tiy/s.asp@f=demo_aspnet_viewstate_classicasp">显示这个例子</a></p>
...
<p class="tiy"><a target="_blank" href="../tiy/s.asp@f=demo_aspnet_button">显示这个例子</a> （请在右边的框架中点击“查看原文档”，您可以看到 ASP .NET 已经向表单中添加了一个隐藏域，这样就可以维持 ViewState。）</p>
</div>
