...
<li class="currentLink"><a href="aspnet_xml.asp" title="WebForms XML 文件">WebForms XML 文件</a></li>
...
<div id="tpn">
<ul class="prenext">
<li class="pre"><a href="aspnet_sortedlist.asp" title="WebForms SortedList">WebForms SortedList</a></li>
<li class="next"><a href="aspnet_repeater.asp" title="WebForms Repeater">WebForms Repeater</a></li>
</ul>
</div>
...
<h2>实例</h2>
<dl>
<dt><a target="_blank" href="../tiy/s.asp@f=demo_aspnet_xml_radio_1">XML RadiobuttonList</a></dt>
</dl>
</div>
...
<p class="tiy"><a target="_blank" href="../tiy/s.asp@f=demo_aspnet_xml_radio_1">显示这个例子</a></p>
</div>
