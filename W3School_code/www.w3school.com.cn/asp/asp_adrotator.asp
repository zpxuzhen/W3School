...
<h2>ASP 组件</h2>
<ul>
<li class="currentLink"><a href="asp_adrotator.asp" title="ASP AdRotator 组件">ASP AdRotator</a></li>
...
<div id="tpn">
<ul class="prenext">
<li class="pre"><a href="asp_ado.asp" title="ADO 简介">ASP ADO</a></li>
<li class="next"><a href="asp_browser.asp" title="ASP Browser Capabilities 组件">ASP BrowserCap</a></li>
</ul>
</div>
...
<h2>实例</h2>
<dl>
<dt><a target="_blank" href="../tiy/s.asp@f=demo_aspe_adrotator">简单的 AdRotator 实例</a></dt>
