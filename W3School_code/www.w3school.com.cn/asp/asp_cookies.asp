...
<li class="currentLink"><a href="asp_cookies.asp" title="ASP Cookies">ASP Cookies</a></li>
...
<div id="tpn">
<ul class="prenext">
<li class="pre"><a href="asp_inputforms.asp" title="ASP 表单和用户输入">ASP 表单</a></li>
<li class="next"><a href="asp_sessions.asp" title="ASP Session">ASP Session</a></li>
</ul>
</div>
