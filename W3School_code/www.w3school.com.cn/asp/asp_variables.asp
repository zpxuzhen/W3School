...
<li class="currentLink"><a href="asp_variables.asp" title="ASP 变量">ASP 变量</a></li>
...
<div id="tpn">
<ul class="prenext">
<li class="pre"><a href="asp_syntax.asp" title="ASP 语法">ASP 语法</a></li>
<li class="next"><a href="asp_procedures.asp" title="ASP 子程序">ASP 程序</a></li>
</ul>
</div>
...
<dt><a target="_blank" href="../tiy/s.asp@f=demo_aspe_fornext2">循环生成 HTML 标题</a></dt>
<dd>如何循环生成 6 个不同的 HTML 标题。</dd>

<dt><a target="_blank" href="../tiy/s.asp@f=demo_aspe_vbtime">使用 Vbscript 制作基于时间的问候语</a></dt>
<dd>本例将根据服务器时间向用户显示不同的消息。</dd>

<dt><a target="_blank" href="../tiy/s.asp@f=demo_aspe_jstime">使用 JavaScript 制作基于时间的问候语</a></dt>
<dd>本例同上，只是语法不同而已。</dd>
</dl>
</div>
