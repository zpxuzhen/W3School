...
<script src="../ajax/selectcustomer.js" type="text/javascript"></script>
...
<li class="currentLink"><a href="asp_ajax_database.asp" title="AJAX 数据库实例">AJAX 数据库</a></li>
</ul>
<h2>ASP 教程总结</h2>
<ul>
...
<div id="tpn">
<ul class="prenext">
<li class="pre"><a href="asp_ajax_asp.asp" title="ASP - AJAX 与 ASP">AJAX ASP</a></li>
<li class="next"><a href="asp_quickref.asp" title="ASP 快速参考">ASP 快速参考</a></li>
</ul>
</div>


<div id="intro">
<p><strong>AJAX 可用来与数据库进行相互的通信。</strong></p>
</div>
...
<p class="tiy"><a target="_blank" href="../tiy/t.asp@f=ajax_database">亲自试一下源代码</a></p>
</div>
