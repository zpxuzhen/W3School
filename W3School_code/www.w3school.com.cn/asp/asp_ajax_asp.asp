...
<li class="currentLink"><a href="asp_ajax_asp.asp" title="ASP - AJAX 与 ASP">AJAX ASP</a></li>
...
<div id="tpn">
<ul class="prenext">
<li class="pre"><a href="asp_ajax_intro.asp" title="AJAX 简介">AJAX 简介</a></li>
<li class="next"><a href="asp_ajax_database.asp" title="AJAX 数据库实例">AJAX 数据库</a></li>
</ul>
</div>
