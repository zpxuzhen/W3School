...
<li class="currentLink"><a href="asp_ref_request.asp" title="ASP Request 对象">ASP Request</a></li>
...
<div id="tpn">
<ul class="prenext">
<li class="pre"><a href="asp_ref_response.asp" title="ASP Response 对象">ASP Response</a></li>
<li class="next"><a href="asp_ref_application.asp" title="ASP Application 对象">ASP Application</a></li>
</ul>
</div>
...
<dl>
<dt><a target="_blank" href="../tiy/s.asp@f=demo_aspe_simplequerystring">当用户点击链接时发送查询信息</a></dt>
<dd>本例演示如何在链接中向页面发送一些额外的查询信息，并在目标页面中取回这些信息（在本例中是同一页面）。</dd>

<dt><a target="_blank" href="../tiy/s.asp@f=demo_aspe_simplereqquery">对 QueryString 集合的简单应用</a></dt>
...
<dl>
<dt><a target="_blank" href="../tiy/s.asp@f=demo_aspe_simpleform1">一个 Form 集合的简单应用</a></dt>
...
<dl>
<dt><a target="_blank" href="../tiy/s.asp@f=demo_aspe_server">获取用户信息</a></dt>
<dd>如何查明访问者的浏览器类型、IP 地址等信息。</dd>

<dt><a target="_blank" href="../tiy/s.asp@f=demo_aspe_servervariables">获取服务器变量</a></dt>
<dd>本例演示如何使用 <em>ServerVariables</em> 集合取得访问者的浏览器类型、IP 地址等信息。</dd>

<dt><a target="_blank" href="../tiy/s.asp@f=demo_aspe_cookies">创建 welcome cookie</a></dt>
