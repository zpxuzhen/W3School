...
<h2>ASP 高级</h2>
<ul>
<li class="currentLink"><a href="asp_ref_response.asp" title="ASP Response 对象">ASP Response</a></li>
...
<div id="tpn">
<ul class="prenext">
<li class="pre"><a href="asp_send_email.asp" title="ASP 使用 CDOSYS 发送电子邮件">ASP 邮件</a></li>
<li class="next"><a href="asp_ref_request.asp" title="ASP Request 对象">ASP Request</a></li>
</ul>
</div>
...
<dl>
<dt><a target="_blank" href="../tiy/s.asp@f=demo_aspe_text">使用 ASP 写文本</a></dt>
<dd>本例演示如何使用 ASP 来写文本。</dd>

<dt><a target="_blank" href="../tiy/s.asp@f=demo_aspe_formatting">在 ASP 中使用 HTML 标签格式化文本</a></dt>
<dd>本例演示如何使用 ASP 将文本和 HTML 标签结合起来。</dd>

<dt><a target="_blank" href="../tiy/s.asp@f=demo_aspe_redirect">将用户重定向至不同的 URL</a></dt>
