...
<li class="currentLink"><a href="asp_summary.asp" title="ASP 课程总结">ASP 课程总结</a></li>
</ul>
<h2>ASP 实例/测验</h2>
<ul>
...
<div id="tpn">
<ul class="prenext">
<li class="pre"><a href="asp_quickref.asp" title="ASP 快速参考">ASP 快速参考</a></li>
<li class="next"><a href="../example/aspe_examples.asp" title="ASP 实例">ASP 实例</a></li>
</ul>
</div>
