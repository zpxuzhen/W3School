...
<li class="currentLink"><a href="asp_send_email.asp" title="ASP 使用 CDOSYS 发送电子邮件">ASP 邮件</a></li>
</ul>
<h2>ASP 高级</h2>
<ul>
...
<div id="tpn">
<ul class="prenext">
<li class="pre"><a href="asp_globalasa.asp" title="ASP Global.asa 文件">ASP Global.asa</a></li>
<li class="next"><a href="asp_ref_response.asp" title="ASP Response 对象">ASP Response</a></li>
</ul>
</div>
