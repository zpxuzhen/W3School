...
<li class="currentLink"><a href="asp_procedures.asp" title="ASP 子程序">ASP 程序</a></li>
...
<div  id="tpn">
<ul class="prenext">
<li class="pre"><a href="asp_variables.asp" title="ASP 变量">ASP 变量</a></li>
<li class="next"><a href="asp_inputforms.asp" title="ASP 表单和用户输入">ASP 表单</a></li>
</ul>
</div>
...
<h2>实例：</h2>
<dl>
<dt><a target="_blank" href="../tiy/s.asp@f=demo_aspe_vbproc">调用使用 VBScript 的子程序</a></dt>
<dd>如何从 ASP 调用以 VBScript 编写的子程序。</dd>

<dt><a target="_blank" href="../tiy/s.asp@f=demo_aspe_jsproc">调用使用 JavaScript 的子程序</a></dt>
<dd>如何从 ASP 调用以 JavaScript 编写的子程序。</dd>

<dt><a target="_blank" href="../tiy/s.asp@f=demo_aspe_vbproc2">调用使用 VBScript 和 JavaScript 的子程序</a></dt>
