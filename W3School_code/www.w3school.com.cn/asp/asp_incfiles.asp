...
<li class="currentLink"><a href="asp_incfiles.asp" title="ASP 文件引用">ASP #include</a></li>
...
<li class="next"><a href="asp_globalasa.asp" title="ASP Global.asa 文件">ASP Global.asa</a></li>
</ul>
</div>
