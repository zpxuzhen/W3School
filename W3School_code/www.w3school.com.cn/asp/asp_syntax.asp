...
<li class="currentLink"><a href="asp_syntax.asp" title="ASP 语法">ASP 语法</a></li>
...
<div id="tpn">
<ul class="prenext">
<li class="pre"><a href="asp_install.asp" title="在自己的 PC 上运行 ASP">ASP 安装</a></li>
<li class="next"><a href="asp_variables.asp" title="ASP 变量">ASP 变量</a></li>
</ul>
</div>
...
<dl>
<dt><a target="_blank" href="../tiy/s.asp@f=demo_aspe_text">用 ASP 写文本</a></dt>
<dd>如果使用 ASP 生成文本。</dd>

<dt><a target="_blank" href="../tiy/s.asp@f=demo_aspe_formatting">向文本添加 HTML</a></dt>
