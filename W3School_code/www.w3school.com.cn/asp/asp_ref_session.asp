...
<li class="currentLink"><a href="asp_ref_session.asp" title="ASP Session 对象">ASP Session</a></li>
...
<div id="tpn">
<ul class="prenext">
<li class="pre"><a href="asp_ref_application.asp" title="ASP Application 对象">ASP Application</a></li>
<li class="next"><a href="asp_ref_server.asp" title="ASP Server 对象">ASP Server</a></li>
</ul>
</div>
...
<dt><a target="_blank" href="../tiy/s.asp@f=demo_aspe_sessionid">返回 SessionID</a></dt>
