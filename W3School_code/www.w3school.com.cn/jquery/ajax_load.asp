...
<p class="tiy"><a target="_blank" href="../tiy/t.asp@f=jquery_ajax_load">亲自试一试</a></p>
...
<dl>
<dt><a target="_blank" href="../tiy/t.asp@f=jquery_ajax_load_data">生成 AJAX 请求，并通过该请求发送数据</a></dt>
<dd>如何使用 data 参数通过 AJAX 请求来发送数据。（本例在 AJAX 教程中解释过。）</dd>

<dt><a target="_blank" href="../tiy/t.asp@f=jquery_ajax_load_func">生成 AJAX 请求，并使用回调函数</a></dt>
<dd>如何使用 function 参数处理来自 AJAX 请求的数据结果。</dd>

<dt><a target="_blank" href="../tiy/t.asp@f=jquery_ajax_load_err">生成带有错误的 AJAX 请求</a></dt>
