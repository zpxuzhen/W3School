...
<p class="tiy"><a target="_blank" href="../tiy/t.asp@f=jquery_event_die">亲自试一试</a></p>
</div>
...
<dl>
<dt><a target="_blank" href="../tiy/t.asp@f=jquery_event_die_function">移除通过 live() 添加的特定函数</a></dt>
