...
<p class="tiy"><a target="_blank" href="../tiy/t.asp@f=jquery_css_width_set">亲自试一试</a></p>
</div>
...
<p class="tiy"><a target="_blank" href="../tiy/t.asp@f=jquery_css_width_get">亲自试一试</a></p>
</div>
...
<p class="tiy"><a target="_blank" href="../tiy/t.asp@f=jquery_css_width_set_function">亲自试一试</a></p>
</div>
...
<dl>
<dt><a target="_blank" href="../tiy/t.asp@f=jquery_css_width_doc_win">获得文档和窗口元素的宽度</a></dt>
<dd>使用 width() 方法来获得 document 和 window 元素的当前宽度。</dd>

<dt><a target="_blank" href="../tiy/t.asp@f=jquery_css_width_set_unit">使用 em 和 % 值来设置宽度</a></dt>
