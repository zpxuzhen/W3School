...
<p class="tiy"><a target="_blank" href="../tiy/t.asp@f=jquery_event_keydown_keyup">亲自试一试</a></p>
</div>
...
<p class="tip"><span>提示：</span>请使用 <a href="event_which.asp" title="jQuery 事件 - which 属性">.which 属性</a>来确定按下了哪个按键（<a target="_blank" href="../tiy/t.asp@f=jquery_event_which">亲自试一试</a>）。</p>
</div>
...
<p class="tiy"><a target="_blank" href="../tiy/t.asp@f=jquery_event_keydown_keyup_trigger">亲自试一试</a></p>
</div>
