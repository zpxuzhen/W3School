...
<dl>
<dt><a target="_blank" href="../tiy/t.asp@f=jquery_hide_this">$(this).hide()</a></dt>
<dd>演示 jQuery 的 hide() 函数，隐藏当前的 HTML 元素。</dd>

<dt><a target="_blank" href="../tiy/t.asp@f=jquery_hide_p">$(&quot;p&quot;).hide()</a></dt>
<dd>演示 jQuery 的 hide() 函数，隐藏所有 &lt;p&gt; 元素。</dd>

<dt><a target="_blank" href="../tiy/t.asp@f=jquery_hide_class">$(&quot;.test&quot;).hide()</a></dt>
<dd>演示 jQuery 的 hide() 函数，隐藏所有 class=&quot;test&quot; 的元素。</dd>

<dt><a target="_blank" href="../tiy/t.asp@f=jquery_hide_id">$(&quot;#test&quot;).hide()</a></dt>
...
<dl>
<dt><a target="_blank" href="../tiy/t.asp@f=jquery_fadeout">jQuery fadeOut()</a></dt>
<dd>演示简单的 jQuery fadeout() 函数。</dd>

<dt><a target="_blank" href="../tiy/t.asp@f=jquery_hide">jQuery hide()</a></dt>
<dd>演示简单的 jQuery hide() 函数。</dd>

<dt><a target="_blank" href="../tiy/t.asp@f=jquery_hide_explanations">Hide explanations</a></dt>
<dd>演示如何隐藏部分文本。</dd>

<dt><a target="_blank" href="../tiy/t.asp@f=jquery_slide_toggle">Slide panel</a></dt>
<dd>演示简单的 Slide Panel 效果。</dd>

<dt><a target="_blank" href="../tiy/t.asp@f=jquery_animation">jQuery animate()</a></dt>
...
<p class="tiy"><a target="_blank" href="../tiy/t.asp@f=jquery_html_change_p">改变 HTML 元素的内容</a>。</p>

<p class="tiy"><a target="_blank" href="../tiy/t.asp@f=jquery_html_append">向 HTML 元素追加内容</a>。</p>

<p class="tiy"><a target="_blank" href="../tiy/t.asp@f=jquery_html_after">在 HTML 元素之后追加内容</a>。</p>
...
<p class="tiy"><a target="_blank" href="../tiy/t.asp@f=jquery_css_change_p">改变 HTML 元素的 CSS 属性</a>。</p>

<p class="tiy"><a target="_blank" href="../tiy/t.asp@f=jquery_css_change_p_and_font">改变多个 CSS 属性</a>。</p>

<p class="tiy"><a target="_blank" href="../tiy/t.asp@f=jquery_css_getcolor">获得元素的 CSS 属性</a>。</p>
...
<p class="tiy"><a target="_blank" href="../tiy/t.asp@f=jquery_ajax1">使用 $(selector).load(url) 来改变 HTML 内容</a>。</p>

<p class="tiy"><a target="_blank" href="../tiy/t.asp@f=jquery_ajax2">使用 $.ajax(options) 来改变 HTML 内容</a>。</p>
