...
<p class="tiy"><a target="_blank" href="../tiy/t.asp@f=jquery_effect_show_hide">亲自试一试</a></p>
</div>
...
<dl>
<dt><a target="_blank" href="../tiy/t.asp@f=jquery_effect_show_hide_speed">使用 speed 参数</a></dt>
<dd>使用 speed 参数来隐藏和显示元素。</dd>

<dt><a target="_blank" href="../tiy/t.asp@f=jquery_effect_show_hide_callback">使用 speed 和 callback 参数</a></dt>
