...
<p class="tiy"><a target="_blank" href="../tiy/t.asp@f=jquery_attributes_addclass">亲自试一试</a></p>
</div>
...
<p class="tiy"><a target="_blank" href="../tiy/t.asp@f=jquery_attributes_addclass_func">亲自试一试</a></p>
...
<dl>
<dt><a target="_blank" href="../tiy/t.asp@f=jquery_attributes_addclass_two">向元素添加两个类</a></dt>
<dd>如何向被选元素添加两个 class。</dd>

<dt><a target="_blank" href="../tiy/t.asp@f=jquery_attributes_addremoveclass">改变元素的类</a></dt>
