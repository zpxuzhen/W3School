...
<p class="tiy"><a target="_blank" href="../tiy/t.asp@f=jquery_css_offset">亲自试一试</a></p>
</div>
...
<p class="tiy"><a target="_blank" href="../tiy/t.asp@f=jquery_css_offset_set">亲自试一试</a></p>
</div>
...
<p class="tiy"><a target="_blank" href="../tiy/t.asp@f=jquery_css_offset_set_function">亲自试一试</a></p>
</div>
...
<dl>
<dt><a target="_blank" href="../tiy/t.asp@f=jquery_css_offset_object">使用对象来为对象设置新的 offset 值</a></dt>
<dd>使用新对象中的坐标来定位元素。</dd>

<dt><a target="_blank" href="../tiy/t.asp@f=jquery_css_offset_object_copy">使用另一个元素的位置来为元素设置新的 offset 值</a></dt>
