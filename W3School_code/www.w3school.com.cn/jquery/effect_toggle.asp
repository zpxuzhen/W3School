...
<p class="tiy"><a target="_blank" href="../tiy/t.asp@f=jquery_effect_toggle">亲自试一试</a></p>
</div>
...
<dl>
<dt><a target="_blank" href="../tiy/t.asp@f=jquery_effect_toggle_speed">使用 speed 参数</a></dt>
<dd>使用 speed 参数来隐藏和显示元素。</dd>

<dt><a target="_blank" href="../tiy/t.asp@f=jquery_effect_toggle_switch">使用 switch 参数</a></dt>
