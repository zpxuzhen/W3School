...
<p class="tiy"><a target="_blank" href="../tiy/t.asp@f=jquery_ajax_ajaxerror">亲自试一试</a></p>
</div>
...
<h2>亲自试一试 - 实例</h2>
<dt>
<dt><a target="_blank" href="../tiy/t.asp@f=jquery_ajax_ajaxerror_options">使用 <i>xhr</i> 和 <i>options</i> 参数</a></dt>
