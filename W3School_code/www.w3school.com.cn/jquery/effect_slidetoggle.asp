...
<p class="tiy"><a target="_blank" href="../tiy/t.asp@f=jquery_effect_slidetoggle">亲自试一试</a></p>
</div>
...
<dl>
<dt><a target="_blank" href="../tiy/t.asp@f=jquery_effect_slidetoggle_speed">使用 speed 参数</a></dt>
