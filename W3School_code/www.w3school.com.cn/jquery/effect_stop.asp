...
<p class="tiy"><a target="_blank" href="../tiy/t.asp@f=jquery_effect_stop">亲自试一试</a></p>
</div>
...
<dl>
<dt><a target="_blank" href="../tiy/t.asp@f=jquery_effect_stop_queue">停止动画队列</a></dt>
<dd>停止被选元素的所有加入队列的动画。</dd>

<dt><a target="_blank" href="../tiy/t.asp@f=jquery_effect_stop_queue_end">在当前动画完成后停止动画队列</a></dt>
