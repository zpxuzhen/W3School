...
<dl>
<dt><a target="_blank" href="../tiy/t.asp@f=jquery_stop_slide">jQuery stop() 滑动</a></dt>
<dd>演示 jQuery stop() 方法。</dd>

<dt><a target="_blank" href="../tiy/t.asp@f=jquery_stop_params">jQuery stop() 动画（带有参数）</a></dt>
<dd>演示 jQuery stop() 方法。</dd>
</dl>
</div>
...
<p class="tiy"><a target="_blank" href="../tiy/t.asp@f=jquery_stop_slide">亲自试一试</a></p>
</div>
