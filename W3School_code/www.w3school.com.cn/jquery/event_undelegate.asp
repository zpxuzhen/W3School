...
<p class="tiy"><a target="_blank" href="../tiy/t.asp@f=jquery_event_undelegate">亲自试一试</a></p>
</div>
...
<p class="tiy"><a target="_blank" href="../tiy/t.asp@f=jquery_event_unbind">亲自试一试</a></p>
...
<dl>
<dt><a target="_blank" href="../tiy/t.asp@f=jquery_event_undelegate_selector">删除事件处理程序，由 delegate() 添加，来自具体选择器</a></dt>
<dd>如何使用 undelegate() 方法从指定元素删除所有事件处理程序。</dd>

<dt><a target="_blank" href="../tiy/t.asp@f=jquery_event_undelegate_event">删除指定事件类型的事件处理程序，由 delegate() 添加，来自指定元素</a></dt>
<dd>如何使用 undelegate() 方法从指定元素删除具体事件类型的所有事件处理程序。</dd>

<dt><a target="_blank" href="../tiy/t.asp@f=jquery_event_undelegate_function">删除由 delegate() 添加的具体函数</a></dt>
