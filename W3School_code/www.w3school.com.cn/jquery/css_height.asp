...
<p class="tiy"><a target="_blank" href="../tiy/t.asp@f=jquery_css_height_set">亲自试一试</a></p>
</div>
...
<p class="tiy"><a target="_blank" href="../tiy/t.asp@f=jquery_css_height_get">亲自试一试</a></p>
</div>
...
<p class="tiy"><a target="_blank" href="../tiy/t.asp@f=jquery_css_height_set_function">亲自试一试</a></p>
</div>
...
<dl>
<dt><a target="_blank" href="../tiy/t.asp@f=jquery_css_height_doc_win">获得文档和窗口元素的高度</a></dt>
<dd>使用 height() 方法来获得 document 和 window 元素的当前高度。</dd>

<dt><a target="_blank" href="../tiy/t.asp@f=jquery_css_height_set_unit">使用 em 和 % 值来设置高度</a></dt>
