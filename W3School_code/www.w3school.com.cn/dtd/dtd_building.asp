...
<li class="currentLink"><a href="dtd_building.asp" title="DTD - XML 构建模块">DTD 构建模块</a></li>
...
<div id="tpn">
<ul class="prenext">
<li class="pre"><a href="dtd_intro.asp" title="DTD 简介">DTD 简介</a></li>
<li class="next"><a href="dtd_elements.asp" title="DTD - 元素">DTD 元素</a></li>
</ul>
</div>
