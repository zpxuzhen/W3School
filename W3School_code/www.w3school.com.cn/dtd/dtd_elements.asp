...
<li class="currentLink"><a href="dtd_elements.asp" title="DTD - 元素">DTD 元素</a></li>
...
<div  id="tpn">
<ul class="prenext">
<li class="pre"><a href="dtd_building.asp" title="DTD - XML 构建模块">DTD 构建模块</a></li>
<li class="next"><a href="dtd_attributes.asp" title="DTD - 属性">DTD 属性</a></li>
</ul>
</div>
