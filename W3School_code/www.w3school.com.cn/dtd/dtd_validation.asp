...
<div  id="tpn">
<ul class="prenext">
<li class="pre"><a href="dtd_entities.asp" title="DTD - 实体">DTD 实体</a></li>
<li class="next"><a href="dtd_examples.asp" title="DTD - 来自网络的实例">DTD 实例</a></li>
</ul>
</div>
...
<p class="tiy"><a target="_blank" href="../tiy/t.asp@f=dtde_note_error_three">Try it Yourself</a> 或者 <a href="../example/dtde/note_dtd_error.xml">仅仅看一下这个 XML 文件</a>。</p>
</div>
