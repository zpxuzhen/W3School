...
<li class="currentLink"><a href="xquery_select.asp" title="XQuery 选择和过滤">XQuery 选取</a></li>
...
<div id="tpn">
<ul class="prenext">
<li class="pre"><a href="xquery_add.asp" title="XQuery 添加元素和属性">XQuery 添加</a></li>
<li class="next"><a href="xquery_functions.asp" title="XQuery 函数">XQuery 函数</a></li>
</ul>
</div>
