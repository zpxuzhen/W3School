...
<li class="currentLink"><a href="xquery_flwor.asp" title="XQuery FLWOR 表达式">XQuery FLWOR</a></li>
...
<div id="tpn">
<ul class="prenext">
<li class="pre"><a href="xquery_example.asp" title="XQuery 实例">XQuery 实例</a></li>
