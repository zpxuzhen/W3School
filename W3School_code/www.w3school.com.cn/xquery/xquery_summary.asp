...
<li class="currentLink"><a href="xquery_summary.asp" title="XQuery 课程总结">XQuery 总结</a></li>
</ul>
<h2>XQuery 参考手册</h2>
<ul>
...
<div id="tpn">
<ul class="prenext">
<li class="pre"><a href="xquery_functions.asp" title="XQuery 函数">XQuery 函数</a></li>
<li class="next"><a href="xquery_reference.asp" title="XQuery 参考手册">XQuery 参考手册</a></li>
</ul>
</div>
