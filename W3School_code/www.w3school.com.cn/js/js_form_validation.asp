...
<li class="currentLink"><a href="js_form_validation.asp" title="JavaScript 表单验证">JS 验证</a></li>
</ul>
<h2>JS HTML DOM</h2>
<ul>
...
<div id="tpn">
<ul class="prenext">
<li class="pre"><a href="js_errors.asp" title="JavaScript 错误 - Throw 和 Try to Catch">JS 错误</a></li>
<li class="next"><a href="js_htmldom.asp" title="JavaScript HTML DOM">DOM 简介</a></li>
</ul>
</div>
