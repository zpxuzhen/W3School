...
<dl>
<dt><a target="_blank" href="../tiy/t.asp@f=jsrf_date">返回当日的日期和时间</a></dt>
<dd>如何使用 Date() 方法获得当日的日期。</dd>

<dt><a target="_blank" href="../tiy/t.asp@f=jseg_date_gettime">getTime()</a></dt>
<dd>getTime() 返回从 1970 年 1 月 1 日至今的毫秒数。</dd>

<dt><a target="_blank" href="../tiy/t.asp@f=jsrf_date_setfullyear2">setFullYear()</a></dt>
<dd>如何使用 setFullYear() 设置具体的日期。</dd>

<dt><a target="_blank" href="../tiy/t.asp@f=jsrf_date_toutcstring">toUTCString()</a></dt>
<dd>如何使用 toUTCString() 将当日的日期（根据 UTC）转换为字符串。</dd>

<dt><a target="_blank" href="../tiy/t.asp@f=jsrf_date_date_weekday">getDay()</a></dt>
