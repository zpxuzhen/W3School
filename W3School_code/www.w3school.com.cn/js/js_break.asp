...
<li class="currentLink"><a href="js_break.asp" title="JavaScript Break 和 Continue 语句">JS Break</a></li>
...
<div id="tpn">
<ul class="prenext">
<li class="pre"><a href="js_loop_while.asp" title="JavaScript While 循环">JS While</a></li>
<li class="next"><a href="js_errors.asp" title="JavaScript 错误 - Throw 和 Try to Catch">JS 错误</a></li>
</ul>
</div>
...
<p class="tiy"><a target="_blank" href="../tiy/t.asp@f=js_break">亲自试一试</a></p>
...
<p class="tiy"><a target="_blank" href="../tiy/t.asp@f=js_continue">亲自试一试</a></p>
</div>
...
<p class="tiy"><a target="_blank" href="../tiy/t.asp@f=js_break_label">亲自试一试</a></p>
</div>
