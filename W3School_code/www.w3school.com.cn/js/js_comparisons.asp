...
<li class="currentLink"><a href="js_comparisons.asp" title="JavaScript 比较和逻辑运算符">JS 比较</a></li>
...
<div id="tpn">
<ul class="prenext">
<li class="pre"><a href="js_operators.asp" title="JavaScript 运算符">JS 运算符</a></li>
<li class="next"><a href="js_if_else.asp" title="JavaScript If...Else 语句">JS If...Else</a></li>
</ul>
</div>
