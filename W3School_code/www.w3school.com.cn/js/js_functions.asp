...
<li class="currentLink"><a href="js_functions.asp" title="JavaScript 函数">JS 函数</a></li>
...
<div id="tpn">
<ul class="prenext">
<li class="pre"><a href="js_obj_intro.asp" title="JavaScript 对象">JS 对象</a></li>
<li class="next"><a href="js_operators.asp" title="JavaScript 运算符">JS 运算符</a></li>
</ul>
</div>
...
<p class="tiy"><a target="_blank" href="../tiy/t.asp@f=js_function1">亲自试一试</a></p>
</div>
...
<p class="tip"><span>提示：</span>JavaScript 对大小写敏感。关键词 function 必须是小写的，并且必须以与函数名称相同的大小写来调用函数。</p>
</div>
...
<pre>
function myFunction(<code>var1</code>,<code>var2</code>)
{
这里是要执行的代码
}
</pre>
...
<p class="tiy"><a target="_blank" href="../tiy/t.asp@f=js_function2">亲自试一试</a></p>

<p>上面的函数会当按钮被点击时提示 &quot;Welcome Bill Gates, the CEO&quot;。</p>
...
<p class="tiy"><a target="_blank" href="../tiy/t.asp@f=js_function3">亲自试一试</a></p>
...
<p class="note"><span>注释：</span>整个 JavaScript 并不会停止执行，仅仅是函数。JavaScript 将继续执行代码，从调用函数的地方。</p>

<p>函数调用将被返回值取代：</p>

<pre>var myVar=myFunction();</pre>

<p>myVar 变量的值是 5，也就是函数 &quot;myFunction()&quot; 所返回的值。</p>

<p>即使不把它保存为变量，您也可以使用返回值：</p>

<pre>document.getElementById(&quot;demo&quot;).innerHTML=myFunction();</pre>
...
<p class="tiy"><a target="_blank" href="../tiy/t.asp@f=js_function_return">亲自试一试</a></p>
...
<p>将声明一个<em>全局</em>变量 carname，即使它在函数内执行。</p>
</div>
