...
<h2>JS HTML DOM</h2>
<ul>
<li class="currentLink"><a href="js_htmldom.asp" title="JavaScript HTML DOM">DOM 简介</a></li>
...
<div id="tpn">
<ul class="prenext">
<li class="pre"><a href="js_form_validation.asp" title="JavaScript 表单验证">JS 验证</a></li>
<li class="next"><a href="js_htmldom_html.asp" title="JavaScript HTML DOM - 改变 HTML">DOM HTML</a></li>
</ul>
</div>


<div>
<p><strong>通过 HTML DOM，可访问 JavaScript HTML 文档的所有元素。</strong></p>
</div>
...
<img src="../i/ct_htmltree.gif" alt="DOM HTML 树" />
...
<p class="tiy"><a target="_blank" href="../tiy/t.asp@f=js_dom_getelementbyid">亲自试一试</a></p>
...
<p class="tiy"><a target="_blank" href="../tiy/t.asp@f=js_dom_getelementsbytagname">亲自试一试</a></p>

<p class="tip"><span>提示：</span>通过类名查找 HTML 元素在 IE 5,6,7,8 中无效。</p>
</div>
