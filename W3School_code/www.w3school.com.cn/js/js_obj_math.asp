...
<h2>实例</h2>
<dl>
<dt><a target="_blank" href="../tiy/t.asp@f=jsrf_math_round">round()</a></dt>
<dd>如何使用 round()。</dd>

<dt><a target="_blank" href="../tiy/t.asp@f=jsrf_math_random">random()</a></dt>
<dd>如何使用 random() 来返回 0 到 1 之间的随机数。</dd>

<dt><a target="_blank" href="../tiy/t.asp@f=jsrf_math_max">max()</a></dt>
<dd>如何使用 max() 来返回两个给定的数中的较大的数。（在 ECMASCript v3 之前，该方法只有两个参数。）</dd>

<dt><a target="_blank" href="../tiy/t.asp@f=jsrf_math_min">min()</a></dt>
