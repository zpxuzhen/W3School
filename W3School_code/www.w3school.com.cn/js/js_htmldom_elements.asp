...
<li class="currentLink"><a href="js_htmldom_elements.asp" title="JavaScript HTML DOM 元素（节点）">DOM 节点</a></li>
</ul>
<h2>JS 对象</h2>
<ul>
...
<div id="tpn">
<ul class="prenext">
<li class="pre"><a href="js_htmldom_events.asp" title="JavaScript HTML DOM 事件">DOM 事件</a></li>
<li class="next"><a href="js_objects.asp" title="JavaScript 对象">JS 对象</a></li>
</ul>
</div>
...
<p class="tiy"><a target="_blank" href="../tiy/t.asp@f=js_dom_elementcreate">亲自试一试</a></p>
...
<p class="tiy"><a target="_blank" href="../tiy/t.asp@f=js_dom_elementremove">亲自试一试</a></p>
