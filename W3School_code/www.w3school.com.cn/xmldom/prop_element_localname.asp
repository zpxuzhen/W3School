...
<h2>TIY</h2>
<dl>
<dt><a target="_blank" href="../tiy/t.asp@f=xdom_localname">localName - 获取节点的本地名称</a></dt>

<dt><a target="_blank" href="../tiy/t.asp@f=xdom_localname2">localName - 获取最后一个子节点的本地名称</a></dt>
</dl>
</div>
