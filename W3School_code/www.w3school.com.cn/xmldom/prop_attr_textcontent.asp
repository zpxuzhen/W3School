...
<h2>TIY</h2>
<dl>
<dt><a target="_blank" href="../tiy/t.asp@f=xdom_attr_textcontent">textContent - 获取属性的文本内容</a>（不支持 IE 浏览器）</dt>

<dt><a target="_blank" href="../tiy/t.asp@f=xdom_attr_textcontent_set">textContent - 设置属性的文本内容</a>（不支持 IE 浏览器）</dt>
</dl>
</div>
