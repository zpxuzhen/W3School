...
<h2>TIY</h2>
<dl>
<dt><a target="_blank" href="../tiy/t.asp@f=xdom_textcontent">textContent - 获取元素的文本节点</a></dt>

<dt><a target="_blank" href="../tiy/t.asp@f=xdom_textcontent2">textContent - 获取元素的文本节点并替换它们</a></dt>
</dl>
</div>
