...
<h2>TIY</h2>
<dl>
<dt><a target="_blank" href="../tiy/t.asp@f=xdom_nodelist_item">item() - 循环遍历节点列表中的项目</a></dt>
<dt><a target="_blank" href="../tiy/t.asp@f=xdom_getnameditem">getNamedItem() - 取得某个项目的值</a></dt>
<dt><a target="_blank" href="../tiy/t.asp@f=xdom_getnameditem2">getNamedItem() - 改变某个项目的值</a></dt>
</dl>
</div>
