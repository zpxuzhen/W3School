...
<h2>TIY</h2>
<dl>
<dt><a target="_blank" href="../tiy/t.asp@f=xdom_document_childnodes">显示 XML 文档的子节点</a></dt>
<dt><a target="_blank" href="../tiy/t.asp@f=xdom_nodetype">显示 XML 文档中所有元素的所有子节点</a></dt>
</dl>
</div>
