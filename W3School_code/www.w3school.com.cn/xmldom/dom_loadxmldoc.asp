...
<h2>实例</h2>
<dl>
<dt><a target="_blank" href="../tiy/t.asp@f=xdom_parser">加载 XML 文档</a></dt>
<dt><a target="_blank" href="../tiy/t.asp@f=xdom_loadxmldoc">使用函数来加载 XML 文档</a></dt>
</dl>
</div>
...
<p class="tiy"><a target="_blank" href="../tiy/t.asp@f=xdom_loadxmldoc">TIY</a></p>
</div>
