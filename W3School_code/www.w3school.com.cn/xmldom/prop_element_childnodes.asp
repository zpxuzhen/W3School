...
<h2>TIY</h2>
<dl>
<dt><a target="_blank" href="../tiy/t.asp@f=xdom_getelementsbytagname">getelemenstByTagname() 和 childNodes - 获取元素的值</a></dt>

<dt><a target="_blank" href="../tiy/t.asp@f=xdom_childnodes_length">childNodes - 获取 NodeList 的长度</a></dt>
</dl>
</div>
