...
<h2>TIY</h2>
<dl>
<dt><a target="_blank" href="../tiy/t.asp@f=xdom_setattribute">setAttribute() - 改变属性的值</a></dt>

<dt><a target="_blank" href="../tiy/t.asp@f=xdom_setattribute2">setAttribute() - 创建新的属性和属性值</a></dt>
</dl>
</div>
