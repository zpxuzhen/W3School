...
<h2>TIY</h2>
<dl>
<dt><a target="_blank" href="../tiy/t.asp@f=xdom_getnameditem">getNamedItem() 和 属性 - 获取项目的值</a></dt>

<dt><a target="_blank" href="../tiy/t.asp@f=xdom_attributes_length">属性和长度 - 从元素中获取属性的数目</a></dt>
</dl>
</div>
