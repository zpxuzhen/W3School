...
<h2>TIY</h2>
<dl>
<dt><a target="_blank" href="../tiy/t.asp@f=xdom_node_textcontent">textContent - 取得某节点的文本内容</a>（IE 不支持）</dt>
<dt><a target="_blank" href="../tiy/t.asp@f=xdom_node_textcontent_set">textContent - 设置某节点的文本内容</a>（IE 不支持）</dt>
</dl>
</div>
