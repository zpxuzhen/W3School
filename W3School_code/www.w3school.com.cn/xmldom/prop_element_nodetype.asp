...
<h2>TIY</h2>
<dl>
<dt><a target="_blank" href="../tiy/t.asp@f=xdom_nodetype">nodeType - 获取整个 XML 文档的节点类型</a></dt>

<dt><a target="_blank" href="../tiy/t.asp@f=xdom_firstchild">nodeType - 忽略空的文本节点</a></dt>
</dl>
</div>
