...
<h2>TIY</h2>
<dl>
<dt><a target="_blank" href="../tiy/t.asp@f=xdom_insertbefore">insertBefore() - 在指定节点之前添加节点</a></dt>
<dt><a target="_blank" href="../tiy/t.asp@f=xdom_element_insertbefore">insertBefore() - 在指定子节点之前添加节点</a></dt>
</dl>
</div>
