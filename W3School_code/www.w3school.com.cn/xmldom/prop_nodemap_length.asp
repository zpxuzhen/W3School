...
<h2>TIY</h2>
<dl>
<dt><a target="_blank" href="../tiy/t.asp@f=xdom_nodemap_length">length - 可返回指定的节点地图中的节点数目</a></dt>
<dt><a target="_blank" href="../tiy/t.asp@f=xdom_length">length - 可返回节点列表中节点的数目</a></dt>
<dt><a target="_blank" href="../tiy/t.asp@f=xdom_length2">length - 可循环遍历节点列表中的节点</a></dt>
</dl>
</div>
