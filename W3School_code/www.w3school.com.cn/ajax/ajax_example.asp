...
<li class="currentLink"><a href="ajax_example.asp" title="AJAX 实例">AJAX 实例</a></li>
</ul>
<h2>AJAX XHR</h2>
<ul>
...
<div id="tpn">
<ul class="prenext">
<li class="pre"><a href="ajax_intro.asp" title="AJAX 简介">AJAX 简介</a></li>
<li class="next"><a href="ajax_xmlhttprequest_create.asp" title="AJAX - 创建 XMLHttpRequest 对象">XHR 创建对象</a></li>
</ul>
</div>
