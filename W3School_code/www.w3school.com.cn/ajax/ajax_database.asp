...
<li class="currentLink"><a href="ajax_database.asp" title="AJAX 数据库实例">AJAX 数据库</a></li>
...
<div id="tpn">
<ul class="prenext">
<li class="pre"><a href="ajax_asp_php.asp" title="AJAX ASP/PHP 实例">AJAX ASP/PHP</a></li>
<li class="next"><a href="ajax_xmlfile.asp" title="AJAX XML 实例">AJAX XML 文件</a></li>
</ul>
</div>
