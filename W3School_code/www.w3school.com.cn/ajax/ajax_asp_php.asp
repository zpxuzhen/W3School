...
<h2>AJAX 高级</h2>
<ul>
<li class="currentLink"><a href="ajax_asp_php.asp" title="AJAX ASP/PHP 实例">AJAX ASP/PHP</a></li>
...
<div id="tpn">
<ul class="prenext">
<li class="pre"><a href="ajax_xmlhttprequest_onreadystatechange.asp" title="AJAX - onreadystatechange 事件">XHR readyState</a></li>
<li class="next"><a href="ajax_database.asp" title="AJAX 数据库实例">AJAX 数据库</a></li>
</ul>
</div>
...
<p class="tiy"><a target="_blank" href="../tiy/t.asp@f=ajax_suggest">亲自试一下源代码</a></p>
</div>
