...
<li class="currentLink"><a href="html_links.asp" title="HTML 链接">HTML 链接</a></li>
...
<div id="tpn">
<ul class="prenext">
<li class="pre"><a href="html_css.asp" title="HTML 样式 - CSS">HTML 样式</a></li>
<li class="next"><a href="html_images.asp" title="HTML 图像">HTML 图像</a></li>
</ul>
</div>
...
<p>上面这行代码显示为：<a href="../default.htm">Visit W3School</a></p>
...
<p class="tiy"><a target="_blank" href="../tiy/t.asp@f=html_link_target">亲自试一试</a></p>
</div>
