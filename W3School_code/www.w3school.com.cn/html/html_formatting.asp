...
<li class="currentLink"><a href="html_formatting.asp" title="HTML 文本格式化">HTML 格式化</a></li>
...
<div id="tpn">
<ul class="prenext">
<li class="pre"><a href="html_paragraphs.asp" title="HTML 段落">HTML 段落</a></li>
<li class="next"><a href="html_editors.asp" title="HTML 编辑器">HTML 编辑器</a></li>
</ul>
</div>
