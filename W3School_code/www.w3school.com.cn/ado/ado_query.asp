...
<li class="currentLink"><a href="ado_query.asp" title="ADO 查询">ADO 查询</a></li>
...
<div id="tpn">
<ul class="prenext">
<li class="pre"><a href="ado_display.asp" title="ADO 显示">ADO 显示</a></li>
<li class="next"><a href="ado_sort.asp" title="ADO 排序">ADO 排序</a></li>
</ul>
</div>
...
<dt><a target="_blank" href="../tiy/s.asp@f=demo_adoe_query_3">仅显示西班牙的客户</a></dt>
<dd>如何仅仅显示 &quot;Customers&quot; 表中的西班牙客户。</dd>

<dt><a target="_blank" href="../tiy/s.asp@f=demo_adoe_query_4">让用户来选择筛选标准</a></dt>
<dd>让用户根据国别来选择客户</dd>
</dl>
</div>
