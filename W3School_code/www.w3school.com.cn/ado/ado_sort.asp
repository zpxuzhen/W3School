...
<li class="currentLink"><a href="ado_sort.asp" title="ADO 排序">ADO 排序</a></li>
...
<div id="tpn">
<ul class="prenext">
<li class="pre"><a href="ado_query.asp" title="ADO 查询">ADO 查询</a></li>
<li class="next"><a href="ado_add.asp" title="ADO 添加记录">ADO 添加</a></li>
</ul>
</div>
...
<dl>
<dt><a target="_blank" href="../tiy/s.asp@f=demo_adoe_sort_1">根据指定的字段名处对记录进行升序排序</a></dt>
<dd>如何根据指定字段名对数据进行排序</dd>

<dt><a target="_blank" href="../tiy/s.asp@f=demo_adoe_sort_2">根据指定的字段名处对记录进行降序排序</a></dt>
<dd>如何根据指定字段名对数据进行排序</dd>

<dt><a target="_blank" href="../tiy/s.asp@f=demo_adoe_sort_3">让用户来选择根据哪列进行排序</a></dt>
