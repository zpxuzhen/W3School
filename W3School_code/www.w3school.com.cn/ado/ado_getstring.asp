...
<li class="currentLink"><a href="ado_getstring.asp" title="ADO 通过 GetString() 加速脚本">ADO 加速</a></li>
</ul>
<h2>ADO 对象</h2>
<ul>
...
<div id="tpn">
<ul class="prenext">
<li class="pre"><a href="ado_delete.asp" title="ADO 删除记录">ADO 删除</a></li>
<li class="next"><a href="ado_ref_command.asp" title="ADO Command 对象">ADO Command</a></li>
</ul>
</div>
...
<dl>
<dt><a target="_blank" href="../tiy/s.asp@f=demo_adoe_display_5">使用 GetString()</a></dt>
...
<p class="note"><span>注释：</span>GetString() 方法是 ADO 2.0 的特性。您可从下面的地址下载 ADO 2.0：<a href="../../www.microsoft.com/data/download.htm">http://www.microsoft.com/data/download.htm</a></p>
