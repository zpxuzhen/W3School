...
<h2>ADO 总结</h2>
<ul>
<li class="currentLink"><a href="ado_datatypes.asp" title="ADO 数据类型">ADO 数据类型</a></li>
...
<div id="tpn">
<ul class="prenext">
<li class="pre"><a href="ado_ref_stream.asp" title="ADO Stream 对象">ADO Stream</a></li>
<li class="next"><a href="ado_summary.asp" title="您已经学习了 ADO，下一步呢？">ADO 总结</a></li>
</ul>
</div>
