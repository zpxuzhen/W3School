...
<li class="currentLink"><a href="ado_display.asp" title="ADO 显示">ADO 显示</a></li>
...
<div id="tpn">
<ul class="prenext">
<li class="pre"><a href="ado_recordset.asp" title="ADO Recordset（记录集）">ADO 记录集</a></li>
<li class="next"><a href="ado_query.asp" title="ADO 查询">ADO 查询</a></li>
</ul>
</div>
...
<dt><a target="_blank" href="../tiy/s.asp@f=demo_adoe_display_3">向 HTML 表格添加标题</a></dt>
