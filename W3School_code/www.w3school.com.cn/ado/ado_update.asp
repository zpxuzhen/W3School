...
<li class="currentLink"><a href="ado_update.asp" title="ADO 更新记录">ADO 更新</a></li>
...
<div id="tpn">
<ul class="prenext">
<li class="pre"><a href="ado_add.asp" title="ADO 添加记录">ADO 添加</a></li>
<li class="next"><a href="ado_delete.asp" title="ADO 删除记录">ADO 删除</a></li>
</ul>
</div>
