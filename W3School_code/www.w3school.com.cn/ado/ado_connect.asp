...
<li class="currentLink"><a href="ado_connect.asp" title="ADO 数据库连接">ADO 连接</a></li>
...
<div id="tpn">
<ul class="prenext">
<li class="pre"><a href="ado_intro.asp" title="ADO 简介">ADO 简介</a></li>
<li class="next"><a href="ado_recordset.asp" title="ADO Recordset（记录集）">ADO 记录集</a></li>
</ul>
</div>
