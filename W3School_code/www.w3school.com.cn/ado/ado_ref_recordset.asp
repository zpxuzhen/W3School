...
<li class="currentLink"><a href="ado_ref_recordset.asp" title="ADO Recordset 对象">ADO Recordset</a></li>
...
<div id="tpn">
<ul class="prenext">
<li class="pre"><a href="ado_ref_record.asp" title="ADO Record 对象">ADO Record</a></li>
<li class="next"><a href="ado_ref_stream.asp" title="ADO Stream 对象">ADO Stream</a></li>
</ul>
</div>
