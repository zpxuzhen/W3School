...
<li class="currentLink"><a href="ado_intro.asp" title="ADO 简介">ADO 简介</a></li>
...
<div id="tpn">
<ul class="prenext">
<li class="pre"><a href="index.asp" title="ADO 教程">ADO 教程</a></li>
<li class="next"><a href="ado_connect.asp" title="ADO 数据库连接">ADO 连接</a></li>
</ul>
</div>
...
<p>如果您希望首先学习这些项目，请在我们的 <a href="../default.htm" title="W3School 在线教程">首页</a> 访问这些教程。</p>
</div>
