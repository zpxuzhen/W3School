...
<h2>ADO 对象</h2>
<ul>
<li class="currentLink"><a href="ado_ref_command.asp" title="ADO Command 对象">ADO Command</a></li>
...
<div id="tpn">
<ul class="prenext">
<li class="pre"><a href="ado_getstring.asp" title="ADO 通过 GetString() 加速脚本">ADO 加速</a></li>
<li class="next"><a href="ado_ref_connection.asp" title="ADO Connection 对象">ADO Connection</a></li>
</ul>
</div>
