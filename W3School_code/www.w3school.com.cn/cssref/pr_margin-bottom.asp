...
<p class="tiy"><a target="_blank" href="../tiy/t.asp@f=csse_margin-bottom">亲自试一试</a></p>
<p>（在页面底部可以找到更多实例）</p>
</div>
...
<dl>
<dt><a target="_blank" href="../tiy/t.asp@f=csse_margin-bottom">设置文本的下外边距 1</a></dt>
<dd>本例演示如何使用厘米值来设置文本的下外边距。</dd>

<dt><a target="_blank" href="../tiy/t.asp@f=csse_margin-bottom_percent">设置文本的下外边距 2</a></dt>
