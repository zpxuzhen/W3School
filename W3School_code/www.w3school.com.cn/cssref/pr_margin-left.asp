...
<p class="tiy"><a target="_blank" href="../tiy/t.asp@f=csse_margin-left">亲自试一试</a></p>
<p>（在页面底部可以找到更多实例）</p>
</div>
...
<dl>
<dt><a target="_blank" href="../tiy/t.asp@f=csse_margin-left">设置文本的左外边距 1</a></dt>
<dd>本例演示如何使用厘米值来设置文本的左边距。</dd>
<dt><a target="_blank" href="../tiy/t.asp@f=csse_margin-left_percent">设置文本的左外边距 2</a></dt>
